                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg font-semibold leading-7">
                                <a href="https://infyom.com/open-source/laravelgenerator/docs/8.0/introduction" class="text-gray-900 underline dark:text-white">
                                    Documentation
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg font-semibold leading-7">
                                <a href="https://github.com/InfyOmLabs/adminlte-generator" class="text-gray-900 underline dark:text-white">
                                    Github
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg font-semibold leading-7">
                                <a href="https://www.youtube.com/channel/UCuCjzuwBqMqFdh0EU-UwQ-w?sub_confirmation=1" class="text-gray-900 underline dark:text-white">
                                    Tutorials
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg font-semibold leading-7 text-gray-900 dark:text-white">
                                <a href="https://infyom.com/blog" class="text-gray-900 underline dark:text-white">
                                    Blogs
                                </a>
                            </div>
                        </div>
