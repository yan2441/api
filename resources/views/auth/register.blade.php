            ...
            <div class="card-body register-card-body">
                ...
                <form method="post" action="{{ route('register') }}">
                    ...
                    <div class="mb-3 input-group">
                        <input type="text" name="CNE" class="form-control @error('CNE') is-invalid @enderror" value="{{ old('CNE') }}" placeholder="CNE">
                    ...
                    <div class="mb-3 input-group">
                        <input type="date" name="date_naissance" class="form-control @error('date_naissance') is-invalid @enderror" value="{{ old('date_naissance') }}" placeholder="date_naissance">
                        <div class="input-group-append">
                            <div class="input-group-text"><span class="fas fa-user"></span></div>
                        </div>
